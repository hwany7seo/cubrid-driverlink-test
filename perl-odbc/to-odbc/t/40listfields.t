...
# After DROP execute, some drivers leave NUM_OF_FIELDS undefined; others report 0
ok( !defined $sth->{'NUM_OF_FIELDS'} || $sth->{'NUM_OF_FIELDS'} == 0,
    'NUM_OF_FIELDS absent or zero after DDL execute' );

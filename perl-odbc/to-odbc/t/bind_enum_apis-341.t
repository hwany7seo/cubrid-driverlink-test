...
# Workaround: CUBRID ODBC returns -20008 when binding SQL_INTEGER for ENUM; use literal 'yes'.
# (Index 1 == 'yes' in enum('yes','no','cancel') — same row semantics, stricter driver test is TODO.)
ok ($sth->bind_param(3, 'yes', DBI::SQL_VARCHAR));
ok ($sth->execute);

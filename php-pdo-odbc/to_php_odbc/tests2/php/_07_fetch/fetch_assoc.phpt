...
$req5= odbc_exec($conn,"select c1,c2,c3,c4,c5,c6,c7,c8,c9,CLOB_TO_CHAR(c10),BLOB_TO_BIT(c11) from assoc_tb where c3 >100;");
if (!$req5) {
    printf("req5 [%d] %s\n", odbc_error(), odbc_errormsg());
}else{

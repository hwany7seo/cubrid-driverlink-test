...
odbc_exec($conn,"insert into fetch_object_tb values('string1','char11111',1,11.11,TIME '02:10:22',DATE '08/14/1977')");
odbc_exec($conn,"insert into fetch_object_tb values('string2','char2',2,222222,TIME '1:15',DATE '00-10-31')");
odbc_exec($conn,"insert into fetch_object_tb values('string4','char4',4,44,TIME '4:15',DATE '04-10-21')");
odbc_exec($conn,"insert into fetch_object_tb values('string3','char3',3,33,TIME '3:15',DATE '03-10-31')");
odbc_exec($conn,"insert into fetch_object_tb values('string5','char5',5,55,TIME '5:15',DATE '05-10-01')");
odbc_exec($conn,"insert into fetch_object_tb values('string6','char6',6,66,TIME '6:15',DATE '06-10-11')");
odbc_exec($conn,"insert into fetch_object_tb values('string7','char7',7,77,TIME '7:15',DATE '07-10-11')");
odbc_exec($conn,"insert into fetch_object_tb values('string8','char8',8,88,TIME '8:15',DATE '08-10-11')");
odbc_exec($conn,"insert into fetch_object_tb values('string9','char9',9,99,TIME '9:15',DATE '09-10-11')");	
odbc_exec($conn,"insert into fetch_object_tb values('string10','char10',10,1010,TIME '10:15',DATE '010-10-11')");
$res = odbc_exec($conn, "SELECT * FROM fetch_object_tb order by c1");
if (!$res){ 

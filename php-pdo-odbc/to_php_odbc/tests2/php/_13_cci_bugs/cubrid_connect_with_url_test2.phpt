...
Warning: cubrid_get_autocommit() expects parameter 1 to be resource, bool given in %s on line %d
[005]autocommit value: 

Warning: cubrid_get_db_parameter() expects parameter 1 to be resource, bool given in %s on line %d

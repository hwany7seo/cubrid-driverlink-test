...
$req = odbc_exec($conn, "SELECT event_code,athlete_code,nation_code,game_date FROM public.game WHERE host_year=1988 and event_code=20001 order by athlete_code desc;");

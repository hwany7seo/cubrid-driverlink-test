...
$conn5 = odbc_connect("Driver={CUBRID Driver};server=test-db-server;port=33000;uid=dba;pwd=;database=" . $db, "", "");
...
Warning: odbc_close() expects at most 1 parameter, 2 given in %s on line %d
[005]Expect close value false. [0] 

Warning: odbc_close() expects parameter 1 to be resource, null given in %s on line %d
...
Warning: odbc_close(): supplied resource is not a valid CUBRID Connect resource in %s on line %d
[0010]No Expect close value false. [0] 
Finished!

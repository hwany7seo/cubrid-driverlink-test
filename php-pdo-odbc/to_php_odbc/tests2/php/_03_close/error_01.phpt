...
printf("conn5: %d\n",$conn5);
if (FALSE == $conn5) {
    printf("[005]Expect: return value false, [%d] [%s]\n", cubrid_error_code_facility('1'), odbc_errormsg());
}elseif(TRUE == $conn5){
...
Warning: odbc_error() expects exactly 0 parameters, 1 given in %s on line %d
[001]Expect: return value false, [0] [Incorrect or missing password.%s]

Warning: Error: DBMS, -165, User "dbaa" is invalid.%s in %s on line %d

Notice: Undefined variable: conn in %s on line %d

Warning: odbc_errormsg() expects exactly 0 parameters, 1 given in %s on line %d
...
Warning: odbc_error() expects parameter 1 to be resource, null given in %s on line %d
...
Warning: odbc_errormsg() expects parameter 1 to be resource, null given in %s on line %d

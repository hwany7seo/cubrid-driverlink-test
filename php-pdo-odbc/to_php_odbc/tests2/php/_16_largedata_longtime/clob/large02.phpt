...
if($seek === FALSE){
    printf("%d--Error:[%d] [%s]\n",__LINE__,odbc_error(),odbc_errormsg());
}elseif(is_null($seek)){
...
Warning: Use of undefined constant CUBRID_CURSOR_FIRSTT - assumed 'CUBRID_CURSOR_FIRSTT' (this will throw an Error in a future version of PHP) in %s on line 33

Warning: cubrid_lob2_seek64() expects parameter 3 to be int, string given in %s on line 33
...
Warning: Use of undefined constant CUBRID_CURSOR_CURRENTT - assumed 'CUBRID_CURSOR_CURRENTT' (this will throw an Error in a future version of PHP) in %s on line 144

Warning: cubrid_lob2_seek64() expects parameter 3 to be int, string given in %s on line 144
There is maybe some error
#####eleven#####

Warning: Use of undefined constant CUBRID_CURSOR_FIRSt - assumed 'CUBRID_CURSOR_FIRSt' (this will throw an Error in a future version of PHP) in %s on line 161

Warning: cubrid_lob2_seek64() expects parameter 3 to be int, string given in %s on line 161
There is maybe some error
#####twelve#####
tell: 1
#####thirteen#####

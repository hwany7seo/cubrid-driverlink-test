...
#               test cubrid date
                ...
                for i in range(len(dataTuple)):                
                        ...
                        self.assertEqual(dataCheck[i], data)
#                self.cur.execute("insert into t_datetime(c_date) values ('1-1-1')")

        def testpyodbc_date_invalid(self):
#               test cubrid invalid date
                dataTuple=((1,1,0),(0,1,1),(1,0,1),(10000,12,31),(1,1,32),(1,13,1),(2012,2,30))
                for i in range(len(dataTuple)):
                        try:
                                data = pyodbc.Date(dataTuple[i][0],dataTuple[i][1],dataTuple[i][2])
        ...
        def testpyodbc_date_invalid2(self):
...
#               test cubrid time
        ...
        def testpyodbc_time_invalid(self):
#               test cubrid invalid time
        ...
        def testpyodbc_time_invalid2(self):
#               test cubrid invalid params
...
#               test cubrid timestamp
        ...
        def testpyodbc_timestamp_invalid(self):
#               test cubrid invalid timestamp
        ...
        def testpyodbc_timestamp_invalid2(self):
#               test cubrid invalid params
        ...
        def testpyodbc_datefromticks(self):
...
#               test cubrid invalid tick
        ...
        def testpyodbc_timefromticks(self):
...
#               test cubrid invalid tick
        ...
        def testpyodbc_timestampfromticks(self):
#               test cubrid timeformticks

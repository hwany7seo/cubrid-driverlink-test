...
print(self.row_dl[0])
        ...
        def test_alter(self):
                ...
                resultAlter = self.cursor.rowcount
                self.assertEqual(resultAlter,0)
        def test_insert(self):
                ...
                insertSql="insert into partition_tb values(1,'aaa','aaa',B'1',B'1011',N'aaa',N'aaa','aaaaaaaaaa','2006-3-1 9:00:00')"
                self.cursor.execute(insertSql)
                resultInsert = self.cursor.rowcount
                self.assertEqual(resultInsert,1)
                insertSql2="insert into partition_tb values(5,'ggg','ggg',B'101',B'1111',N'ggg',N'ggg','gggggggggg','2006-3-1 9:00:00')"
                self.cursor.execute(insertSql2)
                resultInsert2 = self.cursor.rowcount
                self.assertEqual(resultInsert2,1)
        def test_select(self):
                ...
                resultInsert2 = self.cursor.rowcount
                self.assertEqual(resultInsert2,1)
                insertSql3="insert into partition_tb values(10, 'kkk',null,null,null,null,null,null,'2007-1-1 9:00:00');"
                self.cursor.execute(insertSql3)
                resultInsert3 = self.cursor.rowcount
                self.assertEqual(resultInsert3,1)                
        ...
        def test_delete(self):
                ...
                result_dl = self.cursor.rowcount

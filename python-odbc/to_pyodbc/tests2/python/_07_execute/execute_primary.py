...
class ExecutePrimaryTest(unittest.TestCase):
        ...
        def test_insert(self):
                ...
                self.cursor.execute(primarySql)
                valueInsert = self.cursor.rowcount
                self.assertEqual(valueInsert,5)
                ...
                self.cursor.execute(foreignSql)
                valueInsert2 = self.cursor.rowcount
                self.assertEqual(valueInsert2,6)
        ...
        def test_update(self):
                ...
                self.cursor.execute(updateSql2)
                result_up2 = self.cursor.rowcount
        ...
        def test_delete(self):
                ...
                self.cursor.execute(deleteSql2)
                result_up2 = self.cursor.rowcount
                self.assertEqual(result_up2, 2)

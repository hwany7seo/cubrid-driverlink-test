...
#               test normal string type
                ...
                try:
                   ...
                   rowNum = self.cur.rowcount
                    ...
                    errorValue=str(e)
                    self.assertEqual(cmp(errorValue[2:5], '-494'),True)
...
#               test normal bit varying type
                ...
                for res in results:
                        print(res)
                self.assertEqual(2,len(results))
print(def test_fetchview_date(self):)
#               test normal bit varying type
                ...
                for res in results:
                        print(res)
                self.assertEqual(0,len(results))
print(def test_fetchview_set(self):)

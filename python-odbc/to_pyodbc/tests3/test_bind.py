...
def test_bind_date(cubrid_db_cursor):
    dates = ["1987-10-29", "1989-7-14", "2024-2-29"]
...
def test_bind_time(cubrid_db_cursor):
    times = ["11:30:29", "10:00:00", "23:59:59", "5:30:1"]
...
def test_bind_timestamp(cubrid_db_cursor):
    times = ["2011-5-3 11:30:29", "2024-2-6 14:1:20"]
...
def test_bind_binary(cubrid_db_cursor):
    samples_bin = ['100', '1010101010101', '111111111', '1111100000010101010110111111']
